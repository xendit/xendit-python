...
from .sample_response import disbursement_banks_response
from xendit.models import Disbursement
from xendit._api_requestor import _APIRequestor


# fmt: off
class TestGetDisbursementAvailableBanks(BaseModelTest):
    @pytest.fixture
    ...
    def test_send_correct_request_to_api_requestor(self, mocker, mock_correct_response, default_disbursement_data):
        ...
        Disbursement.get_available_banks(*args, **kwargs)
