...
from tests.sampleresponse.direct_debit import multi_customer_response
...
class TestCreateCustomer(ModelBaseTest):
    ...
    def default_customer_data(self):
        ...
        method_name = "get_customer_by_ref_id"
        ...
        params = (args, kwargs)
        url = f"/customers?reference_id={kwargs['reference_id']}"
        expected_correct_result = multi_customer_response()
    ...
    @pytest.mark.parametrize("mock_correct_response", [multi_customer_response()], indirect=True)
