...
class InvoiceCurrency(ModelSimple):
    ...
    def __init__(self, *args, **kwargs):
        ...
        Args:
            args[0] (str): Representing the currency used for an invoice.., must be one of ["IDR", "USD", "PHP", ]  # noqa: E501

        Keyword Args:
            value (str): Representing the currency used for an invoice.., must be one of ["IDR", "USD", "PHP", ]  # noqa: E501
