...
class Capture(ModelNormal):
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, payment_request_id, payment_id, reference_id, currency, authorized_amount, captured_amount, status, payment_method, failure_code, customer_id, metadata, channel_properties, created, updated, *args, **kwargs):  # noqa: E501
        """Capture - a model defined in OpenAPI
