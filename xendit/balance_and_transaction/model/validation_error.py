...
class ValidationError(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'validation': ({str: (bool, date, datetime, dict, float, int, list, str, none_type)}, none_type,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, status_code, error, message, *args, **kwargs):  # noqa: E501
        """ValidationError - a model defined in OpenAPI
