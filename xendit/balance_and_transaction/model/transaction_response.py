...
class TransactionResponse(ModelNormal):
    ...
    def openapi_types():
        ...
        return {
            ...
            'settlement_status': (str, none_type,),  # noqa: E501
            'estimated_settlement_time': (datetime, none_type,),  # noqa: E501
        }
    ...
    @convert_js_args_to_python_args
    def __init__(self, id, product_id, type, status, channel_category, channel_code, account_identifier, reference_id, currency, amount, cashflow, business_id, fee, created, updated, *args, **kwargs):  # noqa: E501
        """TransactionResponse - a model defined in OpenAPI
